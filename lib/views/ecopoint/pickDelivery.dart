...
class PickDelivery extends StatefulWidget {
  @override
  _PickDeliveryState createState() => _PickDeliveryState();
}

class _PickDeliveryState extends State<PickDelivery> {
  DateTime _date;
  TimeOfDay _time;
  CreateDeliveryModel _createDeliveryModel = CreateDeliveryModel.instance;
  Ecopoint ecopoint;
  ...
  void initState() {
    ...
    if (_createDeliveryModel.deliveryDate != null) {
      _date = _createDeliveryModel.deliveryDate;
      _time = _createDeliveryModel.deliveryTime;
      _continueFunction = () {
        if (ecopoint != null) {
          ...
          _createDeliveryModel.deliveryTime = _time;
          _createDeliveryModel.deliveryDate = _date;
          Navigator.pushNamed(context, '/delivery_overview');
        }
      };
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    _createDeliveryModel.ecopoint.openHours.forEach((e) {
